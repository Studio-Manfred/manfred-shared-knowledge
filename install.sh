...
echo ""
echo "   Then install only the plugins you need (11 available — see README):"
echo "     /plugin install manfred-discovery@manfred              # Cagan + Torres discovery"
echo "     /plugin install manfred-design-research@manfred        # interviews, archetypes, JTBD"
echo "     /plugin install manfred-ux-strategy@manfred            # principles, vision, briefs"
echo "     /plugin install manfred-design-systems@manfred         # tokens, components, a11y"
echo "     /plugin install manfred-ui-design@manfred              # layout, colour, type, dark mode"
echo "     /plugin install manfred-interaction-design@manfred     # motion, feedback, errors, state"
echo "     /plugin install manfred-prototyping-testing@manfred    # prototypes, click + A/B tests"
echo "     /plugin install manfred-design-ops@manfred             # handoffs, critiques, sprints"
echo "     /plugin install manfred-toolkit@manfred                # ux-writing, cases, decks, LinkedIn"
